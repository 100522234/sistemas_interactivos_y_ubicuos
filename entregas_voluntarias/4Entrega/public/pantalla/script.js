...
// NUEVO: Lógica de Socket.IO para recibir los comandos del Mando
const socket = io();

socket.on('actualizar-pantalla', (datos) => {
    console.log('Orden recibida del servidor:', datos);
    
    // Seleccionamos el body (o el div que prefieras) y le cambiamos el CSS
    const cuerpo = document.querySelector('body');
    
    if (datos && datos.color) {
        cuerpo.style.backgroundColor = datos.color;
    }
});